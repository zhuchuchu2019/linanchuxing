...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationClient.registerLocationListener(new MyLocationLisenter());
       ...
       if(ContextCompat.checkSelfPermission(MapActivity.this, Manifest.permission.
        ...
        if(ContextCompat.checkSelfPermission(MapActivity.this, Manifest.permission.
            ...
            pemissionList.add(Manifest.permission.WRITE_EXTERNAL_STORAGE);
        }
    ...
    public class MyLocationLisenter implements BDLocationListener{
        @Override
